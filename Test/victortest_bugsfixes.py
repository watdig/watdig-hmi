...
class ModbusConnection:
    ...
    def read_register_input(self, register: int, modbus_id=None):
        if modbus_id is None:
            modbus_id = self.UNIT_ID

        try:
            # Read the register value synchronously
            result = self.client.read_input_registers(register, 1, modbus_id)
...
if __name__ == "__main__":
    ...
    modbus_handler.read_register_holding(0, 7)