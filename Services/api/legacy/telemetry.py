...
def register_routes(router, runtime):
    ...
    def get_speed_dir():
        ...
        speed = runtime.modbus.read_register_holding(100, 1)
    ...
    def get_output_freq():
        ...
        frequency = runtime.modbus.read_register_holding(102, 1)
    ...
    def get_current():
        ...
        current = runtime.modbus.read_register_holding(103, 1)
    ...
    def get_torque():
        ...
        torque = runtime.modbus.read_register_holding(104, 1)
    ...
    def get_power():
        """Get power output"""
        power = runtime.modbus.read_register_holding(105, 1)
    ...
    def get_dc_bus_voltage():
        """Get DC bus voltage"""
        dc_bus_voltage = runtime.modbus.read_register_holding(106, 1)
    ...
    def get_output_voltage():
        """Get output voltage"""
        output_voltage = runtime.modbus.read_register_holding(108, 1)
    ...
    def get_drive_temp():
        ...
        drive_temp = runtime.modbus.read_register_holding(109, 1)
    ...
    def get_cb_temp():
        ...
        cb_temp = runtime.modbus.read_register_holding(149, 1)
    ...
    def get_mot_therm_stress():
        ...
        mot_therm_stress = runtime.modbus.read_register_holding(152, 1)
        return runtime.format_response(mot_therm_stress, "Motor Thermal Stress", "%")

    @router.route("/api/fault/latest-fault", methods=["GET"])
    @runtime.handle_modbus_errors
    def get_latest_fault():
        """Get latest fault code"""
        latest_fault = runtime.modbus.read_register_holding(401, 1)
    ...
    def get_speed_at_fault():
        ...
        speed_at_fault = runtime.modbus.read_register_holding(404, 1)
    ...
    def get_freq_at_fault():
        ...
        freq_at_fault = runtime.modbus.read_register_holding(405, 1)
    ...
    def get_voltage_at_fault():
        ...
        voltage_at_fault = runtime.modbus.read_register_holding(406, 1)
    ...
    def get_current_at_fault():
        ...
        current_at_fault = runtime.modbus.read_register_holding(407, 1)
    ...
    def get_torque_at_fault():
        ...
        torque_at_fault = runtime.modbus.read_register_holding(408, 1)
    ...
    def get_status_at_fault():
        ...
        status_at_fault = runtime.modbus.read_register_holding(409, 1)
